...
const NotFound = () => {
  return (
    ...
    <div class="w-full  flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <p class="text-xl md:text-xl lg:text-3xl font-bold tracking-wider text-black-300 mt-2">Uh-Oh!</p>
        <p class="text-lg md:text-xl lg:text-2xl text-gray-500 my-10">Sorry, the page you are looking for could not be found.</p>
    ...
    <div class=" lg:h-full flex lg:items-end justify-center p-4">
        </div>
</div>
  );
};
