...
import { ReactComponent as ProfileIcon } from "../assets/Profiledark.svg";
        ...
        <div class="h-full px-5 py-4 overflow-y-auto  ">
          <ul class="space-y-2 font-medium">
            ...
            <li>
              <Link
                to="/profile"
                class="flex items-center p-2 text-[#642182] border-r-8 border-[#642182] rounded-lg   hover:text-[#642182] "
              >
                <ProfileIcon />
